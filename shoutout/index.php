...
$create = mysqli_real_escape_string($con, $_GET['create']);
...
echo '<title>Make a shoutout - Crock </title>';

echo '<center><image src="../images/megaphone.png" width="150" /></center>';
...
<b class="x"><image src="../images/megaphone.png" width="30" /> create your shoutout message.</b>
</div>
<br>
</div><br>';
...
<input type="text" class="blogin" id="message" value="" placeholder="Enter your shout out message..." />

</center>

<center><button onclick="shoutIt()" class="vlogin_b"><b>Shout</b></button></center>
